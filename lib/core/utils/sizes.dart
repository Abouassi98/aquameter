import 'package:aquameter/core/extensions/num_extensions.dart';
import 'package:aquameter/core/utils/services/responsive_service.dart';
...
class Sizes {
  ...
  static appBarCustomHeight(BuildContext context) => 180.h(context);
